            ...
            {product.is_free ? (
              <div className="access-box unlocked">
                <div className="access-head ok">
                  ...
                  Chatbot miễn phí — xem link và hướng dẫn bên dưới
                </div>
              ...
              <div className="access-box locked">
                ...
                <div className="access-caption">Hoàn tiền 7 ngày nếu không hài lòng · Bảo hành tài khoản AI {product.warranty || "15 ngày"}</div>
              </div>
            )}
          ...
          <div className="section-card">
            <div className="section-head-row">
              ...
              <div>
                ...
                <div className="sub">Xem video để hiểu cách sử dụng Chatbot này</div>
              </div>
            </div>
            <div className="video-box">
              ...
              <h3>Video bị khoá</h3>
              <p>Mua Chatbot để mở khoá video hướng dẫn</p>
              <Link className="btn btn-primary" href="/dang-nhap">
                Đăng nhập để mua
              </Link>
            </div>
