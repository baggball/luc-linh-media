...
const PRODUCT_VIDEO_DEMOS: Record<string, {
  ...
  "koc-pho-ai-thu-do-video-affiliate": {
    ...
    badge: "VIDEO DEMO THỰC TẾ • KOC PHỐ AI",
    title: "Video thành phẩm KOC Phố AI",
    description: "Xem video thực tế được tạo từ quy trình KOC Phố AI trước khi chọn mua chatbot.",
  },
